...
public class ComponentFactory extends TypeObservable<ComponentBase> {
    ...
    public ComponentFactory(Gem ng, ComponentSpokesman _ComponentSpokesman) {
        _Ng = ng;
    ...
    public <T extends ComponentBase> T createComponent(Class<?> type, Entity ent) {
        ...
        try {
            ...
            if (size != null && size > 0) {
                ...
                el = (T) type.getConstructor(Gem.class, Entity.class, ComponentFactory.class, ComponentSpokesman.class)
