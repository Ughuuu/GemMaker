...
public class ComponentPoint extends ComponentBase {
	...
	private void Recalculate() {
		comb.set(Position.x, Position.y, Position.z, Rotation.x, Rotation.y, Rotation.z, Rotation.w, Scale.x, Scale.y,
				Scale.z);
	...
	protected void Save(XmlWriter element) throws Exception {
		...
		element.element("Component").attribute("Type", Type.getName()).element("Position").attribute("X", Position.x)
				.attribute("Y", Position.y).attribute("Z", Position.z).pop().element("Scale").attribute("X", Scale.x)
				.attribute("Y", Scale.y).attribute("Z", Scale.z).pop().element("Rotation").attribute("X", rot.x)
