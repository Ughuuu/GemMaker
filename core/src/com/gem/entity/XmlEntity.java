...
public class XmlEntity {
    ...
    private void loadScene(String scene){
        ...
        for (Element el : element.getChildrenByName("Include")) {
        	val includeScene = el.getAttribute("Name");
        	loadScene(includeScene);
        }
    ...
    public void Load() {
            ...
            gem.restart();
            loadScene(scene);
            gem.resize(Gdx.graphics.getWidth(), Gdx.graphics.getHeight());
    }
