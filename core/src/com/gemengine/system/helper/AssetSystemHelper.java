...
public class AssetSystemHelper {
	public static void setDefaultLoaders(AssetSystem assetSystem) {
		...
		assetSystem.addLoaderDefault(new LoaderData(BitmapFont.class), new BitmapFontLoader(resolver),
				".fnt");
		assetSystem.addLoaderDefault(new LoaderData(Music.class), new MusicLoader(resolver), ".wav", ".mp3",
				".ogg");
		assetSystem.addLoaderDefault(new LoaderData(Sound.class), new SoundLoader(resolver), ".wav", ".mp3",
				".ogg");
		assetSystem.addTypeFolder(new LoaderData(Sound.class), "sound/");
		assetSystem.addTypeFolder(new LoaderData(Music.class), "music/");
		assetSystem.addLoaderDefault(new LoaderData(Pixmap.class), new PixmapLoader(resolver), ".png",
				".jpg", ".jpeg", ".bmp");
		assetSystem.addLoaderDefault(new LoaderData(TextureAtlas.class), new TextureAtlasLoader(resolver),
				".png", ".jpg", ".jpeg", ".bmp");
		assetSystem.addLoaderDefault(new LoaderData(Texture.class), new TextureLoader(resolver), ".png",
				".jpg", ".jpeg", ".bmp");
		...
		assetSystem.addLoaderDefault(new LoaderData(ParticleEffect.class),
				new ParticleEffectLoader(resolver), ".2dparticle");
		assetSystem.addLoaderDefault(
				new LoaderData(com.badlogic.gdx.graphics.g3d.particles.ParticleEffect.class),
				new com.badlogic.gdx.graphics.g3d.particles.ParticleEffectLoader(resolver), ".3dparticle");
		assetSystem.addLoaderDefault(new LoaderData(PolygonRegion.class), new PolygonRegionLoader(resolver),
				".psh");
		assetSystem.addLoaderOverride(new LoaderData(Model.class),
		...
		assetSystem.addLoaderDefault(new LoaderData(ShaderProgram.class), new ShaderProgramLoader(resolver),
				".vert");
