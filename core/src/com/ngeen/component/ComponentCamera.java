...
public class ComponentCamera extends ComponentBase {
    ...
    public ComponentCamera(Ngeen ng, Entity ent, ComponentFactory factory, ComponentSpokesman _ComponentSpokesman) {
    ...
    protected void Save(XmlWriter element) throws Exception {
        element.element("Component").attribute("Type", _Type.getName()).element("Viewport").attribute("Fov", _Fov)
